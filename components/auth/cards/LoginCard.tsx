...
import { faKey, faEye, faEyeSlash, faAt } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <>
            ...
            <div className="flex-1 min-h-0 flex flex-col">
                <div className="input-group flex flex-col w-full h-full justify-center items-center mt-[calc(var(--gap-y)*2)] gap-[var(--gap-y)]">
                ...
                <div className="flex flex-col shrink-0 h-[var(--oauth-row-h)*1.5] gap-3 justify-center items-center w-full min-w-0 mb-2">
                    <button className="link link-primary text-[var(--font-sz)] text-center mt-2"  onClick={(e) => { e.preventDefault(); setMode('signup'); }}> Or Create a new account </button> 
